          ...
          <div key={project.project_id} className="project-column">
            <div className="room-header">
              ...
              <span className="room-tag">
                {project.auto_pilot ? '⚡ AUTO-PILOT' : '🛡️ HYBRID GATE'}
              </span>
            </div>
            ...
            <div style={{ marginTop: '12px' }}>
              ...
              <div className="live-stream-box">
                {stream.length === 0 ? (
                  <div style={{ color: '#475569', fontStyle: 'italic' }}>Waiting for directives...</div>
                ) : (
                  stream.slice(-30).map((log, i) => (
                    <div key={i} className="stream-entry">
                      ...
                      {log.tool && <span className="stream-tool">⚙️ {log.tool}</span>}
